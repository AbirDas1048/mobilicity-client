...
const Navbar = () => {
    ...
    if (themeMode) {
        document.all[0].setAttribute('data-theme', 'light');
    }
    else {
        document.all[0].setAttribute('data-theme', 'night');
    }
    ...
    const menuItems =
        <>
            <li><Link to="/">Home</Link></li>
            {
                user?.uid ?
                    <>
                        ...
                        {
                            isBuyer && <li><Link to="/buyerDashboard">Dashboard</Link></li>
                        }
            ...
            <label className="swap swap-rotate">
                ...
                <input onChange={() => setThemeMode(!themeMode)} type="checkbox" />
